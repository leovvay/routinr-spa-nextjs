...
export const RoutineCardCover = styled(Image)`
  border-radius: 10px;
...
export const RoutineCardTitle = styled(Text)`
  overflow: hidden;
  white-space: nowrap;
...
export const RoutineCardCreator = styled(Touchable)`
  position: absolute;
  top: 12px;
  left: 12px;
`;

export const RoutineCardInfoContainer = styled.div`
  width: 77%;
  ...
  box-shadow: 0 15px 20px var(--main-card-shadow-color);
...
export const RoutineCardInfoIcon = styled(Image).attrs({
  style: { flexShrink: 0 },
})`
  flex-shrink: 0;
`;

export const RoutineCardInfoText = styled(TextLight)`
  display: inline-flex;
`;

export const RoutineCardInfo = styled.div`
  display: flex;
  align-items: center;
  margin: 2px 0;
...
export const RoutineCardButtonBuy = styled.div`
  align-self: flex-end;
`;

export const RoutineCardCreatorAvatar = styled(Image)`
  border-radius: 50%;
