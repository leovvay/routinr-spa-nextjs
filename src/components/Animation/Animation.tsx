...
export default function Animation(): JSX.Element {
  ...
  const cardStyles1 = {
    xRange: useTransform(
      ...
      [firstPosW1, secondPosW1, secondPosW1, 100]
    ),
    yRange: useTransform(
      scrollYProgress,
      [firstScrollPos, secondScrollPos, thirdScrollPos, fourthScrollPos],
      [-firstPosH1, -secondPosH1, -secondPosH1, 100]
    ),
  };
  ...
  const firstPosW2 = (50 * vwUnit - 357) / 2 - 255 + 193;
  const secondPosH2 = 750 + 100 * vhUnit - 890 + 463;
  const secondPosW2 = 55 * vwUnit - 255;
  const cardStyles2 = {
    xRange: useTransform(
      scrollYProgress,
      [
      ...
      [firstPosW2, secondPosW2, secondPosW2, 129, 338.56]
    ),
    yRange: useTransform(
      scrollYProgress,
      [firstScrollPos, secondScrollPos, thirdScrollPos, fourthScrollPos],
  ...
  const firstPosW3 = (50 * vwUnit - 357) / 2 - 255 + 278;
  const secondPosH3 = 750 + 100 * vhUnit - 890 + 373;
  const secondPosW3 = 80 * vwUnit - 255;
  const cardStyles3 = {
    xRange: useTransform(
      scrollYProgress,
      [
      ...
      [firstPosW3, secondPosW3, secondPosW3, 158, 577.12]
    ),
    yRange: useTransform(
      scrollYProgress,
      [firstScrollPos, secondScrollPos, thirdScrollPos, fourthScrollPos],
  ...
  return (
    <AnimContainer isHidden={isHidden} top={handImgTop}>
      <motion.div
        style={{
          x: spring,
        }}
